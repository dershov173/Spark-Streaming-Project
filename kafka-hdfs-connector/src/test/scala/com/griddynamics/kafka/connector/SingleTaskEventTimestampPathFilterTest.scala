...
class SingleTaskEventTimestampPathFilterTest extends FlatSpec with Matchers with MockFactory {
  "SingleTaskEventTimestampPathFilter" should "return false for corrupted file names" in {
  ...
  "SingleTaskEventTimestampPathFilter" should "return false for all files uploaded earlier than lastUploadedFileTimestamp" in {
  ...
  "SingleTaskEventTimestampPathFilter" should "return true for all files uploaded after lastUploadedFileTimestamp" in {
  ...
  "SingleTaskEventTimestampPathFilter" should "return true for all files uploaded at lastUploadedFileTimestamp with higher internalId" in {
    val lastUploadedFileTimestamp = Gen.posNum[Long].sample.get
